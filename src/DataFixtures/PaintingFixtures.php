...
class PaintingFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($paintings as $data) {
            ...
            // Récupérer les objets Technical et Category depuis les références
            $technical = $this->getReference('technical_' . $data['technical'], Technical::class);
            $category = $this->getReference('category_' . $data['category'], Category::class);
            
            $painting->setTechnical($technical);
